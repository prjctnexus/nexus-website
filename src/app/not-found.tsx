    ...
    return (
        <main className="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8">
            <div className="text-center">
                <p className="text-base font-semibold text-teal-600 dark:text-teal-500">Error 404</p>
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                    ...
                    <Link href="/contact/" className="text-sm font-semibold text-gray-900 dark:text-gray-300">
