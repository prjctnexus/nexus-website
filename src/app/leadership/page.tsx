                    ...
                    {people.map((person) => (
                        <li key={person.name}>
                            <div className="flex items-center gap-x-6">
                                <Image alt="" src={person.imageUrl} className="rounded-full" height={64} width={64} />
                                <div>
                                    <h3 className="text-base/7 font-semibold tracking-tight dark:text-white text-gray-900">{person.name}</h3>
                                    <p className="text-sm/6 font-semibold text-indigo-600 dark:text-teal-400">{person.role}</p>
                                </div>
                            </div>
                        </li>
                    ))}
