    ...
    return (
        <>
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    <div className="lg:pt-4 lg:pr-8">
                        <div className="lg:max-w-lg">
                            <h2 className="text-base/7 font-semibold text-indigo-600 dark:text-teal-500">Introducing The Brand New</h2>
                                ...
                                {features.map((feature) => (
                                    <div key={feature.name} className="relative pl-9">
                                        <dt className="inline font-semibold text-gray-900 dark:text-gray-100">
                                            <feature.icon aria-hidden="true" className="absolute top-1 left-1 size-5 text-indigo-600 dark:text-teal-500" />
                                            {feature.name}
                                        </dt>{' '}
            ...
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8 py-24">
                <h2 className="text-center text-base/7 font-semibold text-indigo-600 dark:text-teal-500">Let{"'"}s Get Into It</h2>
                ...
                <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
                    <div className="relative lg:row-span-2">
                        <div className="absolute inset-px rounded-lg bg-white dark:bg-cyan-800 lg:rounded-l-[2rem]"></div>
                    ...
                    <div className="relative max-lg:row-start-1">
                        <div className="absolute inset-px rounded-lg bg-white dark:bg-sky-950 max-lg:rounded-t-[2rem]"></div>
                    ...
                    <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
                        <div className="absolute inset-px rounded-lg bg-white dark:bg-emerald-700"></div>
                    ...
                    <div className="relative lg:row-span-2">
                        <div className="absolute inset-px rounded-lg bg-white dark:bg-teal-700 max-lg:rounded-b-[2rem] lg:rounded-r-[2rem]"></div>
            ...
            <div className="mx-auto max-w-4xl text-center">
                <h2 className="text-base/7 font-semibold text-indigo-600 dark:text-teal-500">Affordable Pricing</h2>
                ...
                {tiers.map((tier, tierIdx) => (
                    <div
                        ...
                        className={classNames(
                            tier.featured ? 'relative bg-gray-900 dark:bg-teal-950 shadow-2xl' : 'bg-white/60 dark:bg-white/85 sm:mx-8 lg:mx-0',
                            tier.featured
                                ? ''
                                : tierIdx === 0
                    ...
                    >
                        <h3
                            id={tier.id}
                            className={classNames(tier.featured ? 'text-indigo-400 dark:text-teal-400' : 'text-indigo-600 dark:text-teal-600', 'text-base/7 font-semibold')}
                        >
                            {tier.name}
                        </h3>
                        ...
                        <a
                            ...
                            className={classNames(
                                tier.featured
                                    ? 'bg-indigo-500 dark:bg-teal-600 text-white shadow-xs hover:bg-indigo-400 dark:hover:bg-teal-500 focus-visible:outline-indigo-500 dark:focus-visible:outline-teal-700'
                                    : 'text-indigo-600 ring-1 ring-indigo-400 dark:text-teal-600 dark:ring-teal-500 ring-inset hover:ring-indigo-500 focus-visible:outline-indigo-600 dark:focus-visible:outline-teal-700 dark:hover:ring-teal-600',
