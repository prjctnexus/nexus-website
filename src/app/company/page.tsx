        ...
        <>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 sm:mt-6 lg:mt-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    <h2 className="text-base/7 font-semibold text-indigo-600 dark:text-teal-500">Welcome To Project Nexus</h2>
                        ...
                        {features.map((feature) => (
                            <div key={feature.name} className="relative pl-16">
                                <dt className="text-base/7 font-semibold text-gray-900 dark:text-white">
                                    <div className="absolute top-0 left-0 flex size-10 items-center justify-center rounded-lg bg-indigo-600 dark:bg-teal-600">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
                        <div className="grid max-[420px]:grid-cols-1 gap-x-8 gap-y-6 text-base/7 font-semibold grid-cols-2 md:flex lg:gap-x-10">
                            {links.map((link) => (
                                <a key={link.name} href={link.href} className="dark:text-gray-300">
