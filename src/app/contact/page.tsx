                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
                    <div className="max-w-xl lg:max-w-lg">
                        ...
                        <div className="mt-6 flex max-w-md gap-x-4">
                            ...
                            />
                            <button
                                className="flex-none rounded-md bg-indigo-500 dark:bg-teal-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 dark:hover:bg-teal-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 dark:focus-visible:outline-teal-600"
                                onClick={() => {
